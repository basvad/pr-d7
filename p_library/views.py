...
from p_library.models import Author, Book , Publish ,Friend,ReaderProfile
...
class RegisterView(FormView):  
    ...
    def form_valid(self, form):  
        ...
        auth_login(self.request, authenticate(username=username, password=raw_password))  
        return super(RegisterView, self).form_valid(form)  
#обработчик создания профилей
class CreateUserProfile(FormView):  
    ...
    def form_valid(self, form):  
        ...
        instance.reader = self.request.user  
        instance.save()  
...
#обработчик отображающий главную форму
...
def index(request):
    ...
    if request.user.is_authenticated:
        ...
        #получаем из базы все книги
        books = Book.objects.all()
        #словарь контекста
        #context = {"title": "мою библиотеку","books": books,"username":request.user.username,"age":ReaderProfile.objects.get(reader=request.user).age}
    #return HttpResponse(template.render(context, request))
        #context['extra_data']=SocialAccount.objects.get(provider='github', user=request.user).extra_data
        try:
           context = {"title": "мою библиотеку","books": books,"username":request.user.username,
          "extra_data":SocialAccount.objects.get(provider='github', user=request.user).extra_data} 
        except:
          context = {"title": "мою библиотеку","books": books,"username":request.user.username,}
